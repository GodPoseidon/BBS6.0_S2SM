...
<body>
	<div class="center">
		<div id="middle">
			<form action="person/mynews_edit" method="post">
			<input type="hidden" name="news.id" value="${requestScope.news.id }">
			
				<div class="title">
					<span>标题：</span><input type="text" name="news.title" value="${requestScope.news.title }">
				</div>
				<div class="content">
					...
					<div class="right text">
						<textarea rows="25" cols="82" name="news.content">${requestScope.news.content }</textarea>
					</div>
					<div class="clear"></div>
				</div>
				<div class="foot">
